 ...
 */
public class BarangMasukViewModel extends BaseViewModel {

    private final BarangMasukListener listener;

    public BarangMasukViewModel(Context context, BarangMasukListener listener) {
        super(context);
    ...
    private Observable<List<Supplier>> downloadSupplier() {
        ...
        return Rx2AndroidNetworking.post(ConstantNetwork.SUPPLIER)
    ...
    public void kirim(String kode_barang, String nama_barang, String jumlah, String satuan, String kode_supplier) {

        Rx2AndroidNetworking.post(ConstantNetwork.BARANG_MASUK)
                ...
                .addBodyParameter("kode_supplier", kode_supplier)
                .build()
    ...
    public interface BarangMasukListener {
