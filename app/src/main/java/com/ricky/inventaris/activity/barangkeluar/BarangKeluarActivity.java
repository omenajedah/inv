...
import com.ricky.inventaris.databinding.ActivityBarangKeluarBinding;
 ...
 */
public class BarangKeluarActivity extends BaseActivity<ActivityBarangKeluarBinding, BarangKeluarViewModel>
        implements BarangKeluarViewModel.BarangKeluarListener {

    private static final String TAG = BarangKeluarActivity.class.getSimpleName();
    private BarangKeluarViewModel viewModel;
    ...
    public static void startThisActivity(Context context) {
        context.startActivity(new Intent(context, BarangKeluarActivity.class));
    }
    ...
    public int getLayoutId() {
        return R.layout.activity_barang_keluar;
    }

    @Override
    public BarangKeluarViewModel getViewModel() {
        if (viewModel == null)
            viewModel = new BarangKeluarViewModel(this, this);
